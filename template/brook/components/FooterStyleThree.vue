                        ...
                        <div class="footer-address">
                            <div class="row">
                                <div class="col-lg-7 col-sm-6">
                                    <p class="bk_pra line-height-1-63 text-white">2005 Stokes Isle Apt. 896, <br> Vacaville 10010, USA</p>
                                ...
                                <div class="col-lg-5 col-sm-6 mt_mobile--30">
                                    ...
                                    <p class="bk_pra line-height-1-63 bk-hover">
                                        <a class="text-white" href="tel:(+68)120034509">
                                            (+68) 120034509
                                        </a>
                                    </p>
                                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="copyright-right text-md-right text-center">
                        <p class="text-white">© 2020 Brook. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
