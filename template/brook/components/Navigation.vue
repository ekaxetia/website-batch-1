<template>
    <nav class="page_nav">
        <ul class="mainmenu">
                        ...
                        <div class="mega__list">
                            <li class="mega--title">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <nuxt-link to="/about-us-04"><span>About Us 04</span></nuxt-link>
                                    </li>
                                </ul>
                            </li>
                            <li class="mega--title">
            ...
            <li class="lavel-1 with--drop slide--megamenu">
                <n-link to="/portfolio/portfolio-grid-boxed">
                    <span>Portfolio</span>
                </n-link>
                <ul class="mega__width--fullscreen">
                    <div class="container">
                        <div class="mega__list">
                            ...
                            <li class="mega--title">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <nuxt-link to="/portfolio/portfolio-grid-metro-03"><span>Portfolio Grid Metro 03</span></nuxt-link>
                                    </li>
                                    <li>
