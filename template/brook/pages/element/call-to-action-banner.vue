                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="call-btn text-center text-sm-right mt_mobile--20 wow move-up">
                            <button class="brook-btn bk-btn-white text-theme btn-sd-size btn-rounded">Find out more</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="brook-call-to-action bg_color--1 ptb--70">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="call-btn text-center text-sm-right mt_mobile--20 wow move-up">
                            <button class="brook-btn bk-btn-theme btn-sd-size btn-rounded">Find out more</button>
                        </div>
                    </div>
                </div>
            </div>
