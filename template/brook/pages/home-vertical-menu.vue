                        ...
                        <div class="creative-what-do-inner">
                            <div class="inner">
                                ...
                                <div class="about-button mt--55">
                                    <n-link to="" class="brook-btn red-color-2 btn-sd-size btn-rounded space-between">Find out more</n-link>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="post-inner">
                                        ...
                                        <div class="post-meta">
                                            ...
                                            <div class="post-category">
                                                <n-link :to="`/blog/${blog.id}`">{{ blog.category }}</n-link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="call-btn text-center text-sm-right mt_mobile--20">
                                <n-link to="" class="brook-btn bk-btn-white text-theme btn-sd-size btn-rounded">Find out more</n-link>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'Brook || Home Vertical Menu'
            }
        },
