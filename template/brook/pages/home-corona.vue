                ...
                <div class="row">
                    <div class="col-12">
                        <div class="hero-content-5 left">
                            ...
                            <n-link to="/" class="brook-btn bk-btn-white btn-sd-size btn-rounded corona-btn space-between">How to Protect</n-link>
                            <n-link to="/" class="brook-btn bk-btn-theme btn-sd-size btn-rounded corona-btn space-between">Find a Doctor</n-link>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6 wow move-up animate">
                        <div class="about-coronavirus-content">
                            ...
                            <n-link to="" class="brook-btn bk-btn-theme btn-sd-size btn-rounded corona-btn space-between">Learn More</n-link>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 wow move-up animate">
                        <div class="faq-content">
                            ...
                            <n-link to="" class="brook-btn bk-btn-theme btn-sd-size btn-rounded corona-btn space-between mt--20">More Questions</n-link>
                        </div>
                    </div>
                    <div class="col-lg-6 wow move-up animate">
                            ...
                            <div class="post-content">
                                <div class="post-inner">
                                    <div class="post-categories">
                                        <n-link to="" class="theme-color">Life Style</n-link>
                                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 move-up wow mt--30">
                        <div class="blog-grid blog-restaurant">
                            ...
                            <div class="post-content">
                                <div class="post-inner">
                                    <div class="post-categories">
                                        <n-link to="" class="theme-color">Corona</n-link>
                                    </div>
                                    <h3 class="heading heading-h3">
                                        <n-link to="/blog/blog-details">
